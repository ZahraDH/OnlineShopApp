...
@section('content')
    ...
    <form action="{{ route('upload-image.update',$image->id) }}" method="POST" enctype="multipart/form-data">
         ...
         <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        ...
		        <div class="form-group">
		            ...
		            <input type="text" name="product_sku" class="form-control" placeholder="شناسه محصول را وارد کنید" value="{{$image->product->sku}}">
